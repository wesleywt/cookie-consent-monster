...
# The keys of the json file is printed. It shows the keys in the json file. It can also be accessed using data["results"].
...
# We can now change the 'is_cookie_notice' to 0 for True and 1 for False to make the modelling easier. Modelling requires numerical
# values.
...
# ## Splitting the data
# I can split into train and test as well as validation. In the Fuel Efficiency example they do the validation split during the
# model fitting.
#
# In[5]:
